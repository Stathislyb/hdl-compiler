	...
	if( empty($_GET['short_code']) ){
		...
		<div class="form-group">
			<form action="" method="post" id="filter_libraries" onsubmit="return false;">
				<input name="name" type="text" value="<?php echo $name; ?>" class="form-control" placeholder="<?php echo $messages->text[$_SESSION['vhdl_lang']]['Nav_search_4'] ?>" id="filter_libs_input"/>
			</form>
		</div>
