...
--
-- Host: localhost
-- Generation Time: May 21, 2016 at 10:49 AM
...
INSERT INTO `libraries` (`id`, `name`, `owner_id`) VALUES
(1, 'adder.vhdl', 1001),
(2, 'fulladder.vhdl', 1001);
...
(103, 'main.vhdl', 42, 'file', '/', 0),
(118, 'adder.vhdl', 45, 'file', '/', 1),
(119, 'testbench.vhdl', 45, 'file', '/', 1);
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `telephone`, `activated`, `activ_code`, `theme`, `available_space`) VALUES
(1001, 'user1', 'a722c63db8ec8625af6cf71cb8c2d939', 'user1@mymail.me', 2147483647, 1, 0, 5, 20),
(1004, 'user2', 'c1572d05424d0ecb2a65ec6a82aeacbf', 'user2@mymail.me', NULL, 1, 1, 0, 20),
(1007, 'user3', '3afc79b597f88a72528e864cf81856d2', 'user3@mymail.me', NULL, 1, 2, 0, 20),
(1008, 'user4', 'fc2921d9057ac44e549efaf0048b2512', 'user4@mail.com', NULL, 0, 3, 0, 20),
(1010, 'talsiber', '5f4dcc3b5aa765d61d8327deb882cf99', 'e.l.d@live.com', 2147483647, 1, 0, 16, 20);
